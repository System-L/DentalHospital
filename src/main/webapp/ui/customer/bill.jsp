        ...
        <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="bill.jsp"><i class="glyphicon glyphicon-usd">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <button class="btn btn-primary" id="bill_search_modal_btn">查询</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function build_bill_table(result){
        ...
        $.each(bill,function(index,item){
            debugger;
            var billIdTd = $("<td></td>").append(item.id);
    ...
    //根据日期查询就诊记录
    $("#bill_search_modal_btn").click(function(){
        to_page(1);
    })
