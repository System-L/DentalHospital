        ...
        <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="index.jsp"><i class="glyphicon glyphicon-home">
                    ...
                    <li><a href="customerMsg.jsp"><i class="glyphicon glyphicon-plus">
                            ...
                            <div class="portlet box">
                                ...
                                <div class="portlet-body">
                                    <div class="chat-scroller">
                                        <ul class="chats">
                                            <li class="in">
                                                <img src="../../static/images/avatar/48.jpg" class="avatar img-responsive" />
                                                <div class="message">
                                    ...
                                    <div class="profile">
                                        <div style="margin-bottom: 15px" class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4 text-center">
                                                <figure><img src="../../static/images/avatar/128.jpg" alt="" style="display: inline-block" class="img-responsive img-circle"/>
